...
public class ProductSkuView extends JDialog {
    ...
    public ProductSkuView(JFrame parent, Product currentProduct) {
        super(parent, "Manage SKU - Product: " + currentProduct.getName(), true);
    ...
    private void initUI() {
        ...
        inputPanel.add(new JLabel("SKU ID (Empty when adding):"));
        txtId = new JTextField();
        inputPanel.add(txtId);

        inputPanel.add(new JLabel("SKU Code:"));
        ...
        inputPanel.add(new JLabel("Active Status:"));
        ...
        btnAdd = new JButton("Add SKU");
        btnEdit = new JButton("Edit SKU");
        btnDelete = new JButton("Delete SKU");
    ...
    public ProductSku getSkuFromForm() {
        ...
        try {
            ...
            showMessage("Quantity and Weight must be numbers!");
            return null;
        }
    }
    ...
    public void updateRow(int rowIndex, ProductSku sku) {
        ...
        tableModel.setValueAt(sku.getMaterial(), rowIndex, 4);
        tableModel.setValueAt(sku.getQuantityInStock(), rowIndex, 5);
        tableModel.setValueAt(sku.getWeight(), rowIndex, 6);
        tableModel.setValueAt(sku.getBarcode(), rowIndex, 7);
        tableModel.setValueAt(sku.isActive() ? "Yes" : "No", rowIndex, 8);
    }
    ...
    public int getSelectedRow() {
        return skuTable.getSelectedRow();
    }
    ...
    public BigInteger getSelectedId() {
        ...
        if (row >= 0) {
            return new BigInteger(skuTable.getValueAt(row, 0).toString());
        }
    ...
    public void addEditListener(ActionListener log) {
    ...
    public void addClearListener(ActionListener log) {
        btnClear.addActionListener(log);
    }

    public void addManagePriceListener(ActionListener log) {
        btnManagePrice.addActionListener(log);
    }
